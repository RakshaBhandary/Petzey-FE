...
// UPDATE Doctor by ID
    updateData=(e)=>{
      ...
      console.log(newData);
      // axios.put('https://optappointment.learn.skillassure.com/appointment/doctor/doctorEdit/1', newData)
...
componentDidMount() {
  ...
  // axios.get("  https://optappointment.learn.skillassure.com/appointment/doctor/1")
