...
//POST Appointment
  ...
  {
    e.preventDefault();
    // Axios.post('https://optpatient.learn.skillassure.com/patient/appointment/appointments',{

    Axios.post('http://localhost:8080/appointmentAl/post',{
      reasonForVisit
...
{/* <p className="new-appointment-calendar-text d-flex justify-content-center">Your Schedule</p>*/}
           ...
           <div>
            ...
            <button type="button" class='btn btn-outline-dark btn-lg'>11:00</button>
             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>           </div>
          <div>
            <button type="button" class='btn btn-outline-dark btn-lg'>11:00</button>
           ...
           <div>
             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>
             <button type="button" class='btn btn-outline-dark btn-lg'>11:00</button>
             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>
             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>
             <button type='button' class='btn btn-secondary btn-lg' disabled>11:00</button>
