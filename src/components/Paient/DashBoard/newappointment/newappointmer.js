...
function NewAppointment(){
  ...
  {
    e.preventDefault();
    // Axios.post('https://optpatient.learn.skillassure.com/patient/appointment/appointmentss',{
    ...
    // Axios.post('https://optpatient.learn.skillassure.com/patient/patient/patientss',{
    ...
    // Axios.post('https://optpatient.learn.skillassure.com/patient/doctor/doctorss',{
