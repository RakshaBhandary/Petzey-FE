...
export default class patient_profile extends Component{
      ...
      updateData=(e)=>{
        ...
        console.log(newData);
        // axios.put('https://optpatient.learn.skillassure.com/patient/PetParent/petparentEdit/1', newData)
        axios.put('http://localhost:8092/PetParent/petparentEdit/1', newData)
      .then (response => {
        this.setState({patientId:response.id},
        {parentName:response.parentName},
        {parentMobileNo:response.parentMobileNo},
      ...
      //GET PetParent
      componentDidMount(){
        // axios.get("https://optappointment.learn.skillassure.com/appointment/petparent/1")
          axios.get("http://localhost:8080/petparent/1")
          ...
          //Get Patient
          // axios.get("https://optpatient.learn.skillassure.com/patient/patient/getsymptominfo/2")
      ...
      render(){
            return (
              <div className="temp position-absolute"> {/*temp position-absolute */}
                    ...
                    <div className='col-lg-12 col-md-3'>
                                  ...
                                  <div className="modal-body">
                                    ...
                                    <div>
                                      ...
                                      <div className='docinput ml-4'>
                                        ...
                                        <input type="Number" name="parentMobileNo"   onChange={(e) => this.changeHandler(e)}  placeholder='Mobile Number'  />

                                        {/* <input placeholder='Mobile Number'/> */}
                                      </div>
                                      <div className='ml-3'>
                                        <h6 className='text-muted ml-4 mt-3'>Location</h6>
                                        <textarea type ="text" name="location" onChange={(e) => this.changeHandler(e)}     rows="3" cols="50"></textarea>
                      ...
                      <div className='Profile_info'>
                        ...
                        <div>
                          ...
                          <h6 ><span>{this.state.parentMobileNo}</span></h6>
                          <h6 ><span>{this.state.location}</span></h6>
                          <h6 ><span></span></h6>
                        </div>
                      </div>
                    </div>
